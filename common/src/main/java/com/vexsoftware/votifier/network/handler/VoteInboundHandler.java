package com.vexsoftware.votifier.network.handler;
...
public class VoteInboundHandler extends SimpleChannelInboundHandler<Vote> {
    ...
    @Override
    protected void channelRead0(ChannelHandlerContext ctx, final Vote vote) {
    ...
    public void exceptionCaught(ChannelHandlerContext ctx, Throwable cause) {
        ...
        if (!willThrottleErrorLogging()) {
            handler.onError(cause, hasCompletedVote, remoteAddress);
        }
    }
