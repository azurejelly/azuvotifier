package com.vexsoftware.votifier.bukkit.util.redis;
...
public class RedisPoolBuilder {
    ...
    public static JedisPool from(JedisPoolConfig config, RedisCredentials credentials) {
    ...
    public static JedisPool fromCredentials(RedisCredentials credentials) {
        return from(config(), credentials);
    }
}
